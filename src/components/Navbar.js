...
const Navbar = () => {
    return (
        <div className="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <a className="navbar-brand js-scroll-trigger" href="#page-top">Stephen Galvan</a>
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive">
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#blogs">Blogs</a></li>
